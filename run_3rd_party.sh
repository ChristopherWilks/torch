...
prog=sqr
cd squeakr && ../syrupy.py --command-in-front --show-command --no-raw-process-log --syrupy-in-front --separator=, --no-align -i 1 ./main 0 $K_sq 1 $INPUT1 > ../runs/${date}/${K}.1.$prog 2>../runs/${date}/${K}.2.$prog
cd ..
