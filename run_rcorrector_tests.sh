...
do
	...
	../syrupy.py --command-in-front --show-command --no-raw-process-log --syrupy-in-front --separator=, --no-align -i 1 ./rcorrector -t 1 -p ../tests/sim_chr20_read1.fq.gz ../tests/sim_chr20_read2.fq.gz -k 23 -c ../tmp_ee5818769bb7b8219347f982bed69089.jf_dump > sim_chr20_run.sweep.1.only 2> sim_chr20_run.sweep.2.only
